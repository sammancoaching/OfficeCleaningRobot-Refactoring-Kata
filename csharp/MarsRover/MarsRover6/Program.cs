...
class Program
    {
        static void Main(string[] args)
        {
            try
            {
                ...
                Rover oRover = new Rover(); //creating a new object of Robot class
                oRover.StartRoving(alPosition); //call to start visiting process by Robot

                //call to get total no of visited positions
                int iNoOfPositionsVisited = oRover.GetTotalNoOfVisitedPositions();
